        ...
        <div class="modal-dialog modal-notify modal-warning" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header text-center" style="color:black;">
                    <h4 class="modal-title white-text w-100 font-weight-bold py-2">Add Audio Content</h4>
                ...
                <div class="card" style="">
                    ...
                    <div class="card-body">
                        ...
                        {{-- <h5 class="card-header info-color white-text text-center py-4">
                            <strong>Add Audio Content</strong>
                        </h5> --}}
                        <h4 class="card-title"><a></a></h4>
                        {{-- <!-- Text --> --}}
                        <div class="card-text">
                            <form class="text-center" style="color: #757575;" action="audios" method="POST">
                                {{-- field1 --}}
                                {{-- <input type="hidden" name="_token" value="{{ csrf_token() }}"> --}}
                                <div class="md-form">
                                    <input type="text" id="inputAudioName" name="imageName" class="form-control">
                                    <label for="inputAudioName">Audio Name</label>
                                </div>
                
                                <div class="md-form">
                                    <input type="text" id="inputAudioDescription" name="description" class="form-control">
                                    <label for="inputAudioDescription">Audio Description</label>
                                </div>
                
                                <div class="md-form" style="text-align:left;">
                                    <input type="file" id="inputaudio" name="audio">
                                </div>
